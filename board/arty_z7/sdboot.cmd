...
mmc dev $devnum && mmcinfo; run mmc_loadbit; load mmc $devnum:$partid $fdt_addr_r $fdtfile && load mmc $devnum:$partid $kernel_addr_r $kernel_image && bootm $kernel_addr_r - $fdt_addr_r
